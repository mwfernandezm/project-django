    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nombre', models.CharField(max_length=100, unique=True, validators=[inventario.validators.solo_texto])),
            ],
        ),
        migrations.CreateModel(
            name='Orden',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('descripcion', models.TextField(blank=True, validators=[inventario.validators.solo_texto])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('cantidad', models.IntegerField(validators=[inventario.validators.maxima_cantidad])),
                ('precio', models.DecimalField(decimal_places=2, max_digits=10)),
